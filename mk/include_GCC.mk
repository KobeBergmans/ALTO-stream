...
VERSION  = --version
ifeq ($(DEBUG),true)
CXXFLAGS += $(OPENMP) $(BLASCFLAGS) -O0 -static-libasan -O -g -fno-omit-frame-pointer -march=native -static -Wall -g -std=c++17 -D _GLIBCXX_PARALLEL
LIBS	 = -static-libasan -O -g -fno-omit-frame-pointer -lpthread -lm -ldl $(BLASLIBS)
else
